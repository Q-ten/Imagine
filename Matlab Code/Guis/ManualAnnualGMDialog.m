...
if isempty(handles.HIData)
   ...
   handles.HIData.units = 'Yield';
   handles.HIData.HI = 1;
end

handles.units = handles.HIData.units;
handles.HI = handles.HIData.HI;
...
handles.HIData.units = handles.units;
handles.HIData.HI = handles.HI;
guidata(hObject, handles);
